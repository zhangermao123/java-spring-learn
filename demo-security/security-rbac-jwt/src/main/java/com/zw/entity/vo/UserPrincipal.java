...
public class UserPrincipal implements UserDetails {
    ...
    public static UserPrincipal getInstance(SecUser user, Collection<SecRole> roles, Collection<SecPermission> permissions){
    ...
    public boolean isEnabled() {
        return Objects.equals(this.status, ParamKey.ENABLE);
    }
}

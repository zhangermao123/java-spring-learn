...
import com.zw.service.CustomUserDetailService;
...
//                    httpServletResponse.setContentType("application.yml/json;charset=utf-8");
...
//                })
                ...
                .authenticationEntryPoint((req, resp, authException) -> { //处理未正式错误
                            resp.setContentType("application.yml/json;charset=utf-8");
                            PrintWriter out = resp.getWriter();
                            out.write("尚未登录，请先登录");
                            out.flush();
                            out.close();
